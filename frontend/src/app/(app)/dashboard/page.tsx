    ...
    <div className="space-y-7">
      ...
      {items === null ? (
        ...
        <div className="rounded-[10px] border border-dashed border-[#e0e0e0] px-8 py-10 text-center">
          <p className="text-[13px] font-medium text-[#888]">No projects yet</p>
...
const members = p.members as Member[];
            ...
            return (
              <Link
                key={p._id}
                href={`/projects/${p._id}`}
                className="flex flex-col gap-2.5 rounded-[10px] border border-[#e8e8e8] bg-white p-4 transition-all hover:border-[#c0c0c0] hover:bg-[#fafafa]"
              >
                {/* Top row */}
